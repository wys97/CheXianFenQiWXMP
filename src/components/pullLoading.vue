        ...
        <section class="inner" :style="{ transform: 'translate3d(0, ' + top + 'px, 0)' }">
            <div class="pull-refresh">
                <slot name="pull-refresh">
                    <span class="down-tip"><img class="pull-refresh-img" src="../assets/status.gif" />更新成功</span>
                    <span class="up-tip"><img class="pull-refresh-img" src="../assets/status.gif" />松开刷新数据</span>
                    <span class="refresh-tip"><img class="pull-refresh-img" src="../assets/status.gif" />加载中……</span>
                </slot>
            </div>
            <slot>
            </slot>
            <div class="load-more">
                <slot name="load-more">
                    <span v-show="downFlag === false"><img class="pull-refresh-img" src="../assets/status.gif" />加载更多……</span>
                    <span v-show="downFlag === true"><img class="pull-refresh-img" src="../assets/status.gif" />加载中……</span>
                </slot>
            </div>
